...
class Login():
    ...
    def exibir_tela_principal(self):
        ...
        if usuario_digitado in usuarios_aceitos:
            self.frame0.destroy()  
            Application(self.janela, usuario_digitado, self.driver)
        else:
            # Autenticação falhou
...
class Application:
    def __init__(self, janela, usuario_digitado, driver):
        self.driver = driver
        self.janela = janela
        self.usuario_digitado = usuario_digitado
        self.frame_principal()
        self.botoes_tela_principal()
        self.janela.protocol("WM_DELETE_WINDOW", self.fechar_driver)
    ...
    def botoes_tela_principal(self):
                # Adicionar título à tela principal
        titulo_label = Label(self.frame1, text="Escolha uma opção:", font=('Arial', 12, 'bold'), bg='azure1', fg='black')
        titulo_label.place(relx=0.5, rely=0.05, anchor='n')
    ...
    def exibir_tela_cpf(self):
        ...
        formatacao_tela_cpf(self.janela, self.usuario_digitado, self.driver)

    def exibir_tela_emitir_cartao(self):
        self.frame1.pack_forget() 
        formatacao_tela_emitir_cartao(self.janela, self.usuario_digitado, self.driver )
        
    def exibir_tela_memorando(self):
        self.frame1.pack_forget() 
        formatacao_tela_emitir_memorando(self.janela, self.usuario_digitado, self.driver)

    def exibir_tela_trocar_senha(self):
        self.frame1.pack_forget() 
        formatacao_tela_trocar_senha(self.janela, self.usuario_digitado,self.driver)
...
class formatacao_tela_emitir_cartao:
    ...
    def botoes_tela_emitir_cartao(self):
        ...
        titulo_label = Label(self.frame2, text="Gerador de carteiras:", font=('Arial', 12, 'bold'), bg='azure1', fg='black')
        titulo_label.place(relx=0.5, rely=0.05, anchor='n')
    ...
    def voltar_tela_principal(self):
        ...
        Application(janela, self.usuario_digitado, self.driver)  # Crie novamente a tela principal
...
class formatacao_tela_cpf:
    ...
    def botoes_tela_cpf(self):
        ...
        titulo_label = Label(self.frame2, text="Inserir CPF:", font=('Arial', 12, 'bold'), bg='azure1', fg='black')
        titulo_label.place(relx=0.5, rely=0.05, anchor='n')
        ...
        titulo2_label = Label(self.frame2, text="Status:", font=('Arial', 10, 'italic'), bg='azure1', fg='black')
...
class formatacao_tela_emitir_memorando:
    ...
    def botoes_tela_memorando(self):
        ...
        self.titulo_label = Label(self.frame3, text="Insira as Informações:", font=('Arial', 12, 'bold'), bg='azure1', fg='black')
        ...
        self.nmemo_label = Label(self.frame3, text="N° do Memorando:", font=('Arial', 9,), bg='azure1', fg='black')
        self.nmemo_label.place(relx=0.2, rely=0.180, anchor='n')

          # Utilizando o Combobox para o município
        self.unloc_label = Label(self.frame3, text="UNLOC:", font=('Arial', 9,), bg='azure1', fg='black')
        self.unloc_label.place(relx=0.2, rely=0.33, anchor='n')
  ...
  # Substitua com suas siglas desejadas
        ...
        data_emissao = Label(self.frame3, text="Data de emissão da carteira:", font=('Arial', 9,), bg='azure1', fg='black')
        data_emissao.place(relx=0.8, rely=0.180, anchor='n')

        memos_utilizados = Label(self.frame3, text="Memorando Utilizado:", font=('Arial', 9,), bg='azure1', fg='black')
    ...
    # Filtrar os dados do DataFrame com base na entrada do usuário
        ...
        nomes = mensagem.split('\n')
        for nome in nomes:
            self.confirmacao.insert(END, nome)
...
class formatacao_tela_trocar_senha:
    ...
    def botoes_tela_trocar_senha(self):
        ...
        titulo_label = Label(self.frame4, text="Insira a Nova Senha", font=('Arial', 12, 'bold'), bg='azure1', fg='black')
        titulo_label.place(relx=0.5, rely=0.05, anchor='n')
